    ...
    "paths": {
        ...
        "/messages/direct": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The direct message request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.DirectMessagesRequest"
                        }
                    }
                ],
                "responses": {
        ...
        "/messages/team": {
            "post": {
                ...
                "parameters": [
                    {
                        "description": "The team message request",
                        "name": "request",
                        "in": "body",
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/dto.TeamMessagesRequest"
                        }
                    }
                ],
                "responses": {
